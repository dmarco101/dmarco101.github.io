export const ruleDetailsByDetachment = {
  "combined-arms": {
    "enhancements": {
      "Death Mask of Ollanius": {
        "eligibility": "OFFICER model only.",
        ...
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/astra-militarum/#Combined-Arms"
      },
      "Drill Commander": {
        "eligibility": "OFFICER model only.",
      ...
      "Reactive Command": {
        "eligibility": "OFFICER model only.",
        "effect": "Each time an enemy unit is set up within 9\" of the bearer’s unit, the bearer can issue one Order. This is not counted towards the number of Orders the bearer can issue in a battle round .",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/astra-militarum/#Combined-Arms"
      }
    },
  ...
  "bridgehead-strike": {
    "enhancements": {
      "Bombast-class Vox-array": {
        "eligibility": "MILITARUM TEMPESTUS OFFICER model only.",
        "effect": "Each time the bearer issues an Order , if the bearer’s unit contains one or more models equipped with a master vox, it can issue that Order to up to three different REGIMENT units, instead of only one.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/astra-militarum/#Bridgehead-Strike"
      },
      "Priority-drop Beacon": {
        "eligibility": "MILITARUM TEMPESTUS OFFICER model only.",
        "effect": "The bearer’s unit can be set up using the Deep Strike ability in the Reinforcements step of your first, second or third Movement phase , regardless of any mission rules.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/astra-militarum/#Bridgehead-Strike"
      },
      "Shroud Projector": {
        "eligibility": "MILITARUM TEMPESTUS OFFICER model only.",
        "effect": "Enemy units cannot use the Fire Overwatch Stratagem to shoot at the bearer’s unit.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/astra-militarum/#Bridgehead-Strike"
      },
      "Advance Augury": {
        "eligibility": "INFANTRY OFFICER model only.",
        "effect": "After both players have deployed their armies, select up to three REGIMENT units from your army and redeploy them. When doing so, you can set those units up in Strategic Reserves , regardless of how many units are already in Strategic Reserves.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/astra-militarum/#Bridgehead-Strike"
      }
    },
    "stratagems": {
      "Bellicosa Drop": {
        "timing": "The Reinforcements step of your Movement phase .",
      ...
      "Servo-Designators": {
        "timing": "Your Shooting phase , just after an ASTRA MILITARUM INFANTRY unit from your army has shot.",
  ...
  "mechanised-assault": {
    "enhancements": {
      "Bold Leadership": {
        ...
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/astra-militarum/#Mechanised-Assault"
      },
      "Sacred Unguents": {
        "eligibility": "ASTRA MILITARUM TECH-PRIEST ENGINSEER model only.",
        "effect": "At the start of your Shooting phase , select one TRANSPORT from your army (excluding AIRCRAFT and TITANIC units) within 3\" of the bearer. Until the end of the phase, each time that TRANSPORT makes an attack, you can re-roll the Hit roll .",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/astra-militarum/#Mechanised-Assault"
      },
      "Smoke Grenades": {
        "eligibility": "INFANTRY OFFICER model only.",
        "effect": "The bearer’s unit has the Benefit of Cover and the Stealth ability while the bearer’s unit is wholly within 3\" of one or more friendly TRANSPORT models.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/astra-militarum/#Mechanised-Assault"
      },
      "Vanguard Honours": {
        "eligibility": "INFANTRY OFFICER model only.",
        "effect": "The bearer’s unit can disembark from a TRANSPORT after it has Advanced . If it does, it counts as having made a Normal move that phase, and cannot declare a charge in the same turn, but can otherwise act normally in the remainder of the turn.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/astra-militarum/#Mechanised-Assault"
      }
    },
    "stratagems": {
      ...
      "Hasty Extraction": {
        "timing": "Your opponent’s Charge phase , after an enemy unit has selected targets for its charge but before it makes a Charge move .",
  ...
  "hammer-of-the-emperor": {
    "enhancements": {
      "Calm Under Fire": {
        "eligibility": "VEHICLE OFFICER model only.",
        "effect": "Once per turn, after the bearer issues an Order to a SQUADRON unit from your army, it can issue the same Order to another SQUADRON unit from your army.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/astra-militarum/#Hammer-of-the-Emperor"
      },
      "Indomitable Steed": {
        "eligibility": "VEHICLE OFFICER model only.",
        "effect": "The bearer has the Feel No Pain 6+ ability.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/astra-militarum/#Hammer-of-the-Emperor"
      },
      "Regimental Banner": {
      ...
      "Veteran Crew": {
        "eligibility": "VEHICLE OFFICER model only.",
        "effect": "Each time a model in the bearer’s unit makes a ranged attack, re-roll a Hit roll of 1.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/astra-militarum/#Hammer-of-the-Emperor"
      }
    },
    "stratagems": {
      ...
      "Blazing Advance": {
        "timing": "Your Movement phase , just after a SQUADRON unit from your army Advances .",
      ...
      "Tactical Withdrawal": {
        "timing": "Your Movement phase , just after a SQUADRON unit from your army Falls Back .",
        "target": "That SQUADRON unit.",
  ...
  "siege-regiment": {
    "enhancements": {
      "Eager Advance": {
        "eligibility": "INFANTRY OFFICER model only.",
        "effect": "While the bearer is leading a REGIMENT unit, that unit has the Scouts 6\" ability.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/astra-militarum/#Siege-Regiment"
      },
      "Flash Grenades": {
        "eligibility": "INFANTRY OFFICER model only.",
        "effect": "Enemy units cannot use the Fire Overwatch Stratagem to shoot at the bearer’s unit.",
      ...
      "Legacy Sidearm": {
        "eligibility": "INFANTRY OFFICER model only.",
        "effect": "Add 2 to the Attacks characteristics of the bearers Pistols .",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/astra-militarum/#Siege-Regiment"
      },
      "Stalwart’s Honours": {
        "eligibility": "OFFICER model only.",
        "effect": "While the bearer is leading a unit, when that unit is issued an Order, it is also affected by the Take Cover! Order.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/astra-militarum/#Siege-Regiment"
      }
    },
  ...
  "recon-element": {
    "enhancements": {
      "Guerrilla Honours": {
        ...
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/astra-militarum/#Recon-Element"
      },
      "Scare Gas Grenades": {
        "eligibility": "ASTRA MILITARUM INFANTRY model only.",
        "effect": "Once per battle, at the start of any phase, the bearer can use this Enhancement. If it does, select one enemy unit within 8\" of the bearer’s unit (excluding MONSTER and VEHICLE units); that unit must take a Battle-shock test .",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/astra-militarum/#Recon-Element"
      },
      "Survival Gear": {
        "eligibility": "ASTRA MILITARUM INFANTRY model only.",
        "effect": "The bearer has the Scouts 6\" ability.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/astra-militarum/#Recon-Element"
      },
      "Tripwires": {
        "eligibility": "ASTRA MILITARUM INFANTRY model only.",
        "effect": "Each time an enemy INFANTRY or MOUNTED unit ends a Normal , Advance , Charge or Fall Back move within 9\" of the bearer’s unit, roll one D6: on a 4+, until the start of your next turn, that enemy unit is stunned. While a unit is stunned, each time a model in that unit makes an attack, subtract 1 from the Hit roll .",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/astra-militarum/#Recon-Element"
      }
    },
  ...
  "deceptors": {
    "enhancements": {
      "Cursed Fang": {
        "eligibility": "HERETIC ASTARTES INFANTRY model only.",
        "effect": "Improve the Armour Penetration characteristic of the bearer’s melee weapons by 1, and the bearer’s melee weapons have the [PRECISION] ability.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Deceptors"
      },
      "Falsehood": {
    ...
    "stratagems": {
      "Detonator": {
        "timing": "Any phase, just after an enemy model with the Deadly Demise ability (excluding TITANIC models) is destroyed",
      ...
      "From All Sides": {
        "timing": "Start of your Charge phase .",
      ...
      "Coils Of Deception": {
        "timing": "Your Movement phase , just after a HERETIC ASTARTES unit from your army Falls Back .",
      ...
      "Scrambled Coordinates": {
        "timing": "Start of the Reinforcements step of your opponent’s Movement phase .",
        "target": "One HERETIC ASTARTES unit from your army.",
  ...
  "renegade-raiders": {
    "enhancements": {
      "Despot’s Claim": {
        "eligibility": "HERETIC ASTARTES model only.",
        "effect": "At the start of your Command phase , if the bearer is on the battlefield, roll one D6, adding 1 to the result if the bearer is wholly within 12\" of your opponent’s deployment zone: on a 5+, you gain 1 CP.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Renegade-Raiders"
      },
      "Dread Reaver": {
        "eligibility": "HERETIC ASTARTES model only.",
        "effect": "Each time the bearer makes a melee attack, if the bearer is wholly within 12\" of your opponent’s deployment zone, you can re-roll the Hit roll and you can re-roll the Wound roll .",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Renegade-Raiders"
      },
      "Mark of the Hound": {
        "eligibility": "HERETIC ASTARTES model only.",
        "effect": "Models in the bearers unit have the Scouts 6\" ability.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Renegade-Raiders"
      },
      "Tyrant’s Lash": {
        "eligibility": "HERETIC ASTARTES model only.",
        "effect": "You can re-roll Advance rolls made for the bearer’s unit, and the bearer’s unit is eligible to shoot in a turn in which it Fell Back .",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Renegade-Raiders"
      }
    },
    "stratagems": {
      ...
      "Ruinous Raid": {
        "timing": "Your Shooting phase or your Fight phase",
  ...
  "chaos-cult": {
    "enhancements": {
      "Amulet of Tainted Vigour": {
        "eligibility": "DARK APOSTLE model only.",
        "effect": "In your Command phase , you can return up to D3 destroyed DAMNED models (excluding CHARACTER models) to the bearer’s unit.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Chaos-Cult"
      },
      "Cultist’s Brand": {
        "eligibility": "DARK APOSTLE or DAMNED model only.",
        "effect": "If every other model in the bearer’s unit (excluding Dark Disciples) is DAMNED , you can re-roll Advance and Charge rolls made for the bearer’s unit.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Chaos-Cult"
      },
      "Incendiary Goad": {
        "eligibility": "DARK APOSTLE or DAMNED model only.",
        "effect": "While the bearer’s unit is below its Starting Strength , add 1 to the Strength characteristic of melee weapons equipped by DAMNED models in that unit, and while that unit is Below Half-strength , add 1 to the Attacks characteristic of those weapons as well.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Chaos-Cult"
      },
      "Warped Foresight": {
        "eligibility": "DARK APOSTLE or DAMNED model only.",
        "effect": "While the bearer is leading a unit with the Scouts 6\" ability, every model in the bearer’s unit has the Scouts 6\" ability.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Chaos-Cult"
      }
    },
    "stratagems": {
      ...
      "Mortal Thralls": {
        "timing": "Your opponent’s Shooting phase , just after an enemy unit has selected ts targets.",
  ...
  "pactbound-zealots": {
    "enhancements": {
      "Eye of Tzeentch": {
        "eligibility": "HERETIC ASTARTES TZEENTCH model only.",
        "effect": "Each time the bearer’s unit makes a Dark Pact and does not fail the resulting Leadership test , if the result of that test was 8 or more, you gain 1CP.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Pactbound-Zealots"
      },
      "Intoxicating Elixir": {
        "eligibility": "HERETIC ASTARTES SLAANESH model only.",
      ...
      "Orbs of Unlife": {
        "eligibility": "HERETIC ASTARTES NURGLE model only.",
        "effect": "At the end of the Fight phase , roll one D6 for every enemy unit within 3\" of the bearer, adding 1 to the result if the bearer’s unit made a Dark Pact that phase and did not fail the resulting Leadership test : on a 4+, that enemy unit suffers D3 mortal wounds .",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Pactbound-Zealots"
      },
      "Talisman of Burning Blood": {
        "eligibility": "HERETIC ASTARTES KHORNE model only.",
    ...
    "stratagems": {
      "Eye Of The Gods": {
        "timing": "Fight phase , just after a HERETIC ASTARTES CHARACTER unit from your army (excluding DAMNED , DAEMON and EPIC HERO units) destroys a enemy unit.",
  ...
  "veterans-long-war": {
    "enhancements": {
      "Eager for Vengeance": {
        ...
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Veterans-of-the-Long-War"
      },
      "Eye of Abaddon": {
        "eligibility": "See source eligibility.",
        "effect": "HERETIC ASTARTES model only (excluding DAMNED models). While the bearer is on the battlefield, each time your focus of hatred is destroyed , roll one D6: on a 4+, you gain 1CP.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Veterans-of-the-Long-War"
      },
      "Mark of Legend": {
        "eligibility": "See source eligibility.",
        "effect": "HERETIC ASTARTES model only (excluding DAMNED models). Once per turn, you can re-roll one Hit roll , one Wound roll or one saving throw made for the bearer.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Veterans-of-the-Long-War"
      },
      "Warmaster’s Gift": {
        "eligibility": "CHAOS LORD model only.",
        "effect": "Each time the bearer makes an attack that targets your focus of hatred , an unmodified successful Wound roll of 5+ scores a Critical Wound .",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Veterans-of-the-Long-War"
      }
    },
    "stratagems": {
      "Endless Ire": {
        "timing": "Any phase, just after your focus of hatred is destroyed .",
      ...
      "Contemptuous Disregard": {
        "timing": "Your opponents Shooting phase or the Fight phase , just after an enemy unit has selected its targets.",
        "target": "One HERETIC ASTARTES unit from your army (excluding DAMNED units) that was selected as the target of one or more of the attacking unit’s attacks.",
        "effect": "Until the attacking unit has finished making its attacks, each time an attack targets your unit, worsen the Armour Penetration characteristic of that attack by 1.",
        "restrictions": "No additional restriction stated.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Veterans-of-the-Long-War"
  ...
  "fellhammer-siege-host": {
    "enhancements": {
      ...
      "Iron Artifice": {
        "eligibility": "HERETIC ASTARTES INFANTRY model only.",
        "effect": "The bearers weapons have the [ANTI-VEHICLE 4+] and [ANTI-FORTIFICATION 4+] abilities.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Fellhammer-Siege-host"
      },
      "Ironbound Enmity": {
        "eligibility": "HERETIC ASTARTES model only.",
        "effect": "Each time the bearer makes an attack while within range of an objective marker , add 1 to the Wound roll .",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Fellhammer-Siege-host"
      },
      "Warp Tracer": {
        "eligibility": "HERETIC ASTARTES model only.",
        "effect": "In your Shooting phase , after the bearer has shot, select one enemy unit hit by one or more of those attacks. Until the end of the phase, that enemy unit cannot have the Benefit of Cover .",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Fellhammer-Siege-host"
      }
    },
    "stratagems": {
      ...
      "Siegecraft": {
        "timing": "Start of your opponents Charge phase .",
        "target": "One HERETIC ASTARTES unit from your army.",
  ...
  "dread-talons": {
    "enhancements": {
      "Eater of Dread": {
        "eligibility": "HERETIC ASTARTES model only.",
        "effect": "At the start of your Command phase , if the bearer is on the battlefield, roll one D6, adding 1 to the result for each Battle-shocked enemy unit that is on the battlefield: on a 5+, you gain 1CP.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Dread-Talons"
      },
      "Night’s Shroud": {
        "eligibility": "See source eligibility.",
        "effect": "CHAOS LORD model only (excluding TERMINATOR models). Models in the bearer’s unit have the Stealth ability.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Dread-Talons"
      },
      "Warp-fuelled Thrusters": {
        "eligibility": "JUMP PACK CHAOS LORD model only.",
        "effect": "At the end of your opponent’s turn, if the bearer’s unit is not within Engagement Range of one or more enemy units, you can remove the bearer’s unit from the battlefield and place it into Strategic Reserves .",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Dread-Talons"
      },
      "Willbreaker": {
        "eligibility": "HERETIC ASTARTES model only.",
        "effect": "In the Fight phase , after the bearer has made its attacks, select one enemy unit hit by one or more of those attacks. That unit must take a Battle-shock test .",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Dread-Talons"
      }
    },
    "stratagems": {
      ...
      "Bloody Example": {
        "timing": "Fight phase , just after a HERETIC ASTARTES unit from your army destroys a CHARACTER unit.",
        "target": "That HERETIC ASTARTES unit.",
      ...
      "Relentless Terror": {
        "timing": "Your Movement phase , just after a HERETIC ASTARTES INFANTRY unit from your army Falls Back .",
  ...
  "soulforged-warpack": {
    "enhancements": {
      "Forge’s Blessing": {
        "eligibility": "HERETIC ASTARTES model only.",
        "effect": "In your Command phase , select one friendly HERETIC ASTARTES VEHICLE unit within 12\" of the bearer. Until the start of your next Command phase , that unit has the Feel No Pain 6+ ability.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Soulforged-Warpack"
      },
      "Invigorated Mechatendrils": {
        "eligibility": "WARPSMITH model only.",
        "effect": "Add 4\" to the bearer’s Move characteristic.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Soulforged-Warpack"
      },
      "Tempting Addendum": {
        "eligibility": "HERETIC ASTARTES model only.",
        "effect": "Each time a HERETIC ASTARTES DAEMON VEHICLE unit from your army invokes its contract while within 3\" of the bearer: | If it suffers one or more mortal wounds as a result of that Dark Pact , add 1 to the number of mortal wounds it suffers. Until the end of the phase, each time a model in that unit makes an attack, you can re-roll the Hit roll .",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Soulforged-Warpack"
      },
      "Soul Harvester": {
        "eligibility": "HERETIC ASTARTES model only.",
        "effect": "While the bearer is on the battlefield, each time an enemy unit within 12\" of the bearer is destroyed , roll one D6: on a 5+, you gain 1CP.",
        "restrictions": "Apply only to the eligible bearer or unit described above.",
        "sourceUrl": "https://wahapedia.ru/wh40k10ed/factions/chaos-space-marines/#Soulforged-Warpack"
      }
    },
    "stratagems": {
      ...
      "Feeding Frenzy": {
        "timing": "Your opponent’s Movement phase , when an enemy unit (excluding MONSTER and VEHICLES ) is selected to Fall Back .",
